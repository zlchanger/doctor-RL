...
class SFTDataset(Dataset):
    ...
    def __getitem__(self, item):
        ...
        ########################## Original Codes ##########################
        prompt_chat_str, response_chat_str = apply_chat_template(tokenizer, prompt, response, with_thinking=self.with_thinking, add_generation_prompt=True, tokenize=False)
